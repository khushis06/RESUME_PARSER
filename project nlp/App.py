...
def run():
    ...
    if choice == 'Normal User':
        ...
        if pdf_file is not None:
            ...
            #     time.sleep(4)
            save_image_path = 'C:/Users/Parth/Desktop/KHUSHI/project nlp/Uploaded_Resumes' + pdf_file.name
            ...
            if resume_data:
                ...
                if 'Internship' in resume_text:
                    resume_score = resume_score + 25
                    st.markdown('''<h4 style='text-align: left; color: #1ed760;'>[+] Awesome! You have added your Internship </h4>''',unsafe_allow_html=True)
                else:
                    st.markdown('''<h4 style='text-align: left; color: #fabc10;'>[-] According to our recommendation please add Internship. It will show that you have done work related the required position or not.</h4>''',unsafe_allow_html=True)
                if 'Training' in  resume_text:
                    resume_score = resume_score + 20
                    st.markdown('''<h4 style='text-align: left; color: #1ed760;'>[+] Awesome! You have added your Training </h4>''',unsafe_allow_html=True)
                else:
                    st.markdown('''<h4 style='text-align: left; color: #fabc10;'>[-] According to our recommendation please add Trainin. It will show that you have done work related the required position or not.</h4>''',unsafe_allow_html=True)
        ...
        if st.button('Login'):
            if ad_user == 'sra_admin' and ad_password == 'admin123':
                st.success("Welcome ")
                # Display Data
